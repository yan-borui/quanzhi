...
from CharacterFactory import get_character_factory, get_character_registry
...
def select_characters(min_players: int = 2, max_players: int = 6) -> List[Character]:
    """
    角色选择界面
    ...
    if confirm != 'y':
        print("取消选择，重新开始...")
        return select_characters(min_players, max_players)
